...
O projeto será construído progressivamente ao longo da disciplina, implementando boas práticas de desenvolvimento frontend com HTML, CSS e JavaScript, e consumindo uma API Fake via JSON Server.
...
- [🖼️ Protótipo no Figma](#) - *A definir*
